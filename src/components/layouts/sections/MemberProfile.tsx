...
export default function MemberProfile() {
  ...
  return (
    <section className="section__container min-h-[100dvh] px-0 py-20">
      <h2 className="text-3xl lg:text-4xl">Member's Profile</h2>
      <div className="member__profile__container mt-10 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Link href={`/profiles/${member.name}`} key={index}>
              <figure className="relative w-full border-4">
                <Image
                  ...
                  quality={100}
                  loading="lazy"
                  className="aspect-[3/4] max-w-full object-cover"
                />
