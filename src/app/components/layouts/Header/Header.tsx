...
import iveBg from "../../assets/ive.jpg";
...
export default function Header() {
  return (
    <header className="min-h-screen flex flex-col justify-end items-center bg-[#000] relative">
      <figure className="coba__parallax bg-fixed">{/* <Image src={iveBg} alt={`${iveBg} img`} className="max-w-full block bg-fixed an" /> */}</figure>
