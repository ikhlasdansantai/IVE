      ...
      <div className="p-4 sm:ml-64">
        <div className="p-4 border-2 border-gray-200  border-dashed rounded-lg dark:border-gray-700 mt-14">
          <div className="grid grid-cols-3 gap-4 mb-4">
              ...
              <div className="cards">
                <ul role="list" className="flex flex-col divide-y divide-gray-200 dark:divide-gray-700 mt-10">
                  <li className="py-3 sm:py-4">
                    ...
                    <p className="mt-4">
                      Hello <span className="text-blue-600">@designteam</span> Let's schedule a kick-off meeting and workshop this week. It would be great to gather everyone involved in the design project. Let me know about your
                      availability in the thread. Looking forward to it! Thanks.
                    </p>
            ...
            {/* Top Fans */}
            <div className="flex flex-col col-start-3 items-start py-4 px-4 rounded bg-gray-300 dark:bg-gray-800">
              <h2 className="text-2xl font-semibold">Top Fans 🚀</h2>
              <div className="cards mt-10 space-y-4">
                <div className="card flex items-center gap-3">
                  <figure className="w-12 h-12 bg-black rounded-full"></figure>
                  <p className="text-slate-700 text-lg">TOP IVE FANS #1</p>
                </div>
                <div className="card flex items-center gap-3 ">
                  <figure className="w-12 h-12 bg-black rounded-full"></figure>
                  <p className="text-slate-700 text-lg">Si Ganteng</p>
                </div>
                <div className="card flex items-center gap-3 ">
                  <figure className="w-12 h-12 bg-black rounded-full"></figure>
                  <p className="text-slate-700 text-lg">Si Tamvan</p>
                </div>
              </div>
            </div>
          </div>
